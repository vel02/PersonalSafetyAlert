...
public class ContactVORecyclerAdapter extends RecyclerView.Adapter<BaseBindHolder> {
    ...
    public void refresh(List<ContactVO> contacts) {
    ...
    public BaseBindHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case CONTACT_TYPE:
                ItemContactVoBinding bindingContact = DataBindingUtil
                        .inflate(LayoutInflater.from(parent.getContext()),
                                R.layout.item_contact_vo,
                                parent, false);
                return new ContactVOBindHolder(bindingContact.getRoot());
            case EXHAUSTED_TYPE:
            default:
    ...
    public interface OnContactClickListener {
        void onContactResult(ContactVO contact);
    }
